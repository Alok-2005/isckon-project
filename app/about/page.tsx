...
const AboutPage = () => {
  const [activeTab, setActiveTab] = useState('about-iskcon');
  ...
  return (
    ...
    <div className="max-w-6xl mx-auto px-4 py-8">
      ...
      <Head>
        <title>About ISKCON | International Society for Krishna Consciousness</title>
      ...
      <div className="text-sm text-gray-600 mb-6">
        ...
        <span> &gt; </span>
        <span className="text-blue-600 hover:underline cursor-pointer">About</span>
        <span> &gt; </span>
          ...
          <nav>
            <ul className="space-y-2">
              <li 
                ...
                onClick={() => setActiveTab('about-iskcon')}
              >
                About ISKCON
              </li>
              <li 
